        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimedEntity_Open = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimedEntity_Close = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimedEntity_Grade = table.Column<double>(type: "float", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAssignment", x => new { x.UserId, x.AssignmentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentExam", x => new { x.UserId, x.ExamId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentQuestion", x => new { x.UserId, x.BaseQuestionId });
                    table.ForeignKey(
